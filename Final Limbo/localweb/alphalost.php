...
<?php   
     ...
     echo '<TABLE border="0">';
       echo '<TR>';
         ...
         echo '<TH><font size= "100">Report Lost Items<font></TH>';
...
<?php
     ...
     if ($_SERVER[ 'REQUEST_METHOD' ] == 'POST') {
          ...
          if(!valid_name($item)) {
	           ...
	           echo '<p style="color:red;font-size:16px;">Add Date Lost</p>';
        } else if (!valid_name($location)) {
             echo '<p style="color:red;font-size:16px;">Add Location Lost</p>';
